    ...
    <main className="product-detail-page animate-fade-up" style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column' }}>
      ...
      <div style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '40px 20px' }}>
        ...
        >
          ...
          {error && (
            <div
              className="validation-error font-mono"
              role="alert"
              style={{
                borderColor: 'var(--red-live)',
                color: 'var(--red-live)',
          ...
          <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '18px' }}>
            <div className="form-group">
              <label className="font-mono label-input" htmlFor="login-email">
                EMAIL ADDRESS
              </label>
              <input
                id="login-email"
            ...
            <div className="form-group">
              <label className="font-mono label-input" htmlFor="login-password">
                PASSWORD
              </label>
              <input
                id="login-password"
          ...
          <p className="text-muted font-mono" style={{ textAlign: 'center', fontSize: '0.78rem' }}>
            ...
            <Link
              href="/register"
              className="font-mono"
              style={{ color: 'var(--sand2)', textDecoration: 'underline', textUnderlineOffset: '3px' }}
            >
              CREATE ONE →
            </Link>
          </p>
